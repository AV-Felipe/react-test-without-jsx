  ...
  return (
    React.createElement(
      ...
      React.createElement(
        "div",
        null,
        (location.state?.message && React.createElement(Message, { message: location.state.message, type: location.state.type }))
      ),
      React.createElement(
        "div",
        {className: styles.contend_container},
        React.createElement(
          "h2",
          null,
          userData.username
